package example.com.updatedemo.utils;
...
import example.com.updatedemo.MainActivity;
import example.com.updatedemo.R;
import okhttp3.Call;
...
public class DownloadService extends Service {
    ...
    private void setNotification() {
        ...
        resultIntent.addCategory(Intent.CATEGORY_LAUNCHER);//防止应用被杀死
        ...
        mBuilder = new NotificationCompat.Builder(application);
